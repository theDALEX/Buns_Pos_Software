...
Welcome Buns POS is an open-source Point of Sale (POS) software project that started as a university project. Our goal is to provide an affordable, flexible, and easy-to-use POS solution for small businesses and local shops.
